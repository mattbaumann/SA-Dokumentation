...
\clearpairofpagestyles % Remove all previously defined page styles
...
\geometry{vmargin=4cm, headheight=37pt, left=6cm, right=2cm, marginparwidth=3.5cm, marginparsep=0.5cm}
...
\newcommand{\headerFooterContent} {
    ...
    \KOMAoptions{headwidth = textwithmarginpar:-\the\marginparwidth-\the\marginparsep:marginpar}
    \KOMAoptions{footwidth = textwithmarginpar:-\the\marginparwidth-\the\marginparsep:marginpar}
    ...
    \rofoot{\thepage\ von \lastpageref*{LastPages}}
    \refoot{\today}
    \cefoot{{ \small \@author}}
    \lefoot{\thepage\ von \lastpageref*{LastPages}}
    \lofoot{\today}
    \cofoot{{\small \@author}}
}
...
%% Marginals %%
%%%%%%%%%%%%%%%%%%%%%
\newcommand{\marg}[1]{\marginpar{\raggedright\small\textbf{#1} }}

\reversemarginpar % marginpar on left side
...
\providecaptionname{english}{\authors}{Author(s):}
\providecaptionname{ngerman}{\authors}{Autor(en):}
\providecaptionname{english}{\dates}{Date:}
\providecaptionname{ngerman}{\dates}{Datum:}